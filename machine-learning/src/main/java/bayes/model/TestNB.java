...
public class TestNB {
	...
	public static void main(String[] args) {
		// 1.读取数据，放入list容器中
		File file = new File("E:\\pself\\machine-learning\\src\\main\\test\\testBayes.txt");
		txt2String(file);
		// 数据测试样本
	...
	public static void testData(int age, String a, String b, String c) {
		...
		/// 未知用户的判断
		double nb_buy_yes = (1.0 * num_age_yes / number_yes) * (1.0 * num_income_yes / number_yes)
				* (1.0 * num_student_yes / number_yes) * (1.0 * num_credit_yes / number_yes) * buy_yes;
		double nb_buy_no = (1.0 * num_age_no / bumber_no) * (1.0 * num_income_no / bumber_no)
				* (1.0 * num_stdent_no / bumber_no) * (1.0 * num_credit_no / bumber_no) * buy_no;
